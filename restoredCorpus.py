...
game2_roles = {'Muuo': 'werewolf', 'John': 'seer', 'Frederick': 'bodyguard',
    ...
    'Amanda': 'cult leader', 'Platter': 'villager', 'Sartaj': 'villager',
    'Lazar': 'villager'}
...
game3_roles = {'Sartaj': 'villager', 'Muuo': 'bodyguard', 'Peter': 'villager',
    ...
    'Darwin': 'cub', 'Physics': 'werewolf', 'Yonis': 'villager',
    'Navid': 'villager', 'Elvira': 'villager', 'Jamal': 'villager',
    'Platter': 'villager'}
...
game4_roles = {'Sartaj': 'cursed', 'Muuo': 'cult leader', 'Darwin': 'cub',
    ...
    'Physics': 'villager', 'Yonis': 'villager', 'Navid': 'villager',
    'Elvira': 'villager'}
...
game5_roles = {'Sartaj': 'villager', 'Muuo': 'seer', 'Peter': 'werewolf',
    ...
    'Platter': 'villager', 'Yonis': 'villager', 'Physics': 'villager',
    'Sohrab': 'villager', 'Elvira': 'villager', 'Jess': 'villager'}
...
game6_roles = {'Sartaj': 'cub', 'Muuo': 'lycan', 'Darwin': 'cursed',
    ...
    'Amanda': 'seer', 'Physics': 'villager', 'Sohrab': 'villager',
    'Jamal': 'villager'}
...
game7_roles = {'Muuo': 'villager', 'Caroline': 'seer', 'Darwin': 'villager',
    ...
    'Peter': 'werewolf', 'Navid': 'villager', 'Amanda': 'villager',
    'Sohrab': 'villager', 'Andrew': 'villager', 'Moustafa': 'villager',
    'Elvira': 'villager', 'Samantha': 'villager', 'Physics': 'villager',
    'Platter': 'villager'}
...
game8_roles = {'Muuo': 'bodyguard', 'Peter': 'villager', 'Physics': 'villager',
    ...
    'Caroline': 'villager', 'Navid': 'villager', 'Andrew': 'villager',
    'Moustafa': 'villager', 'Elvira': 'villager', 'Samantha': 'villager',
    'Platter': 'villager'}
...
game9_roles = {'Muuo': 'werewolf', 'Peter': 'lycan', 'Caroline': 'villager',
    ...
    'Amanda': 'villager', 'Moustafa': 'villager', 'Elvira': 'villager',
    'Physics': 'villager'}
...
game10_roles = {'Muuo': 'lycan', 'Darwin': 'werewolf', 'Caroline': 'villager',
    ...
    'Platter': 'villager', 'Amanda': 'villager', 'Moustafa': 'villager',
    'Physics': 'villager'}
...
game11_roles = {'Muuo': 'cursed', 'Darwin': 'seer', 'Caroline': 'werewolf',
    ...
    'Amanda': 'werewolf', 'Sohrab': 'villager', 'Andrew': 'villager',
    'Moustafa': 'villager', 'Samantha': 'villager', 'Physics': 'villager',
    'Platter': 'villager'}
...
game12_roles = {'Muuo': 'villager', 'Platter': 'werewolf',
    ...
    'Amanda': 'bodyguard', 'Sohrab': 'villager', 'Andrew': 'villager',
    'Samantha': 'villager', 'Physics': 'villager'}
...
game13_roles = {'Muuo': 'seer', 'Platter': 'villager', 'Frederick': 'lycan',
    ...
    'Darwin': 'bodyguard', 'Amanda': 'cursed', 'Peter': 'villager',
    'Caroline': 'villager', 'Navid': 'villager', 'Sohrab': 'villager',
    'Andrew': 'villager', 'Elvira': 'villager', 'Samantha': 'villager',
    'Physics': 'villager'}
...
game14_roles = {'Sartaj': 'villager', 'Muuo': 'werewolf', 'Platter': 'lycan',
    ...
    'Amanda': 'bodyguard', 'Darwin': 'villager', 'Physics': 'villager',
    'Dave': 'villager', 'Elvira': 'villager', 'Krystal': 'villager',
    'Caroline': 'villager'}
...
game15_roles = {'Sartaj': 'seer', 'John': 'villager', 'Darwin': 'villager',
    ...
    'Andrew': 'villager', 'Muuo': 'villager', 'Krystal': 'villager',
    'Caroline': 'villager'}
...
game16_roles = {'Sartaj': 'seer', 'Peter': 'villager', 'Physics': 'villager',
    ...
    'Muuo': 'villager', 'Andrew': 'villager', 'Lazar': 'villager',
    'Krystal': 'villager', 'John': 'villager', 'Platter': 'villager',
    'Caroline': 'villager'}
...
game17_roles = {'Sartaj': 'cursed', 'Caroline': 'cult leader',
    ...
    'Physics': 'werewolf', 'Platter': 'villager', 'Muuo': 'villager',
    'Sohrab': 'villager', 'Andrew': 'villager', 'Lazar': 'villager',
    'Krystal': 'villager', 'John': 'villager'}
...
game18_roles = {'Sartaj': 'spellcaster', 'Darwin': 'cursed',
    ...
    'Muuo': 'villager', 'Sohrab': 'villager', 'Andrew': 'villager',
    'Lazar': 'villager', 'John': 'villager'}
...
game20_roles = {'Sartaj': 'lycan', 'Peter': 'werewolf', 'Caroline': 'villager',
    ...
    'Physics': 'bodyguard', 'Platter': 'cult leader', 'Muuo': 'villager',
    'Sohrab': 'villager', 'Andrew': 'villager', 'Lazar': 'villager',
    'John': 'villager'}
...
game21_roles = {'Sartaj': 'spellcaster', 'Muuo': 'cub', 'Caroline': 'lycan',
    ...
    'Darwin': 'werewolf', 'Platter': 'villager', 'Navid': 'villager',
    'Sohrab': 'villager', 'Physics': 'villager', 'Tim': 'villager',
    'Lazar': 'villager', 'Amanda': 'villager', 'Rachel': 'villager'}
...
game22_roles = {'John': 'werewolf', 'Caroline': 'spellcaster', 'Peter': 'seer',
    ...
    'Sartaj': 'villager', 'Muuo': 'villager', 'Navid': 'villager',
    'Sohrab': 'villager', 'Physics': 'villager', 'Frederick': 'villager',
...
game23_roles = {'Rachel': 'villager', 'Tim': 'lycan', 'Melissa': 'bodyguard',
    ...
    'Amanda': 'villager', 'Elvira': 'villager', 'Physics': 'villager',
    'Peter': 'villager', 'Frederick': 'villager', 'Linda': 'villager'}
...
game24_roles = {'Sartaj': 'villager', 'Darwin': 'bodyguard',
    ...
    'Platter': 'villager', 'Muuo': 'villager', 'Sohrab': 'villager',
    'Peter': 'villager', 'Frederick': 'villager', 'Andrew': 'villager',
    'Lazar': 'villager', 'Linda': 'villager', 'Amanda': 'villager',
    'Rachel': 'villager'}
...
game25_roles = {'Sartaj': 'werewolf', 'Muuo': 'werewolf', 'Peter': 'lycan',
    ...
    'Darwin': 'spellcaster', 'Amanda': 'bodyguard', 'Elvira': 'villager',
    'Laura': 'villager', 'Samantha': 'villager', 'Platter': 'villager'}
...
game26_roles = {'Sartaj': 'villager', 'Muuo': 'spellcaster',
    ...
    'Platter': 'werewolf', 'Navid': 'villager', 'Samantha': 'villager',
    'Amanda': 'villager'}
...
game27_roles = {'Sartaj': 'bodyguard', 'Darwin': 'cursed',
    ...
    'Amanda': 'villager', 'Muuo': 'villager', 'Peter': 'villager',
    'Physics': 'villager'}
...
game28_roles = {'Sartaj': 'villager', 'Muuo': 'cursed', 'John': 'werewolf',
    ...
    'Physics': 'werewolf', 'Caroline': 'villager', 'Amanda': 'villager',
    'Tim': 'villager', 'Dave': 'villager'}
...
game31_roles = {'Sartaj': 'villager', 'Muuo': 'werewolf', 'John': 'villager',
    ...
    'Darwin': 'bodyguard', 'Physics': 'seer', 'Caroline': 'villager',
    'Navid': 'villager', 'Frederick': 'villager'}
...
game32_roles = {'Sartaj': 'villager', 'Sohrab': 'villager',
    ...
    'Darwin': 'villager', 'Caroline': 'villager', 'Philippa': 'villager',
    'Dave': 'villager'}
...
game34_roles = {'Darwin': 'bodyguard', 'Frederick': 'villager', 'Steve': 'bomb',
    ...
    'Physics': 'villager', 'Platter': 'werewolf', 'Sartaj': 'villager',
    'Philippa': 'villager', 'Sohrab': 'villager', 'Elvira': 'villager'}
...
game35_roles = {'Sartaj': 'werewolf', 'Platter': 'werewolf',
    ...
    'Darwin': 'cursed', 'Physics': 'villager', 'Philippa': 'villager',
    'Dave': 'villager'}
...
game36_roles = {'Sartaj': 'villager', 'Caroline': 'werewolf',
    ...
    'Physics': 'seer', 'Philippa': 'villager', 'Sohrab': 'villager',
    'Elvira': 'villager', 'Dave': 'villager', 'Krystal': 'villager',
    'Platter': 'villager'}
...
game37_roles = {'Peter': 'werewolf', 'Navid': 'bodyguard', 'Amanda': 'villager',
    ...
    'Physics': 'seer', 'Platter': 'villager', 'Caroline': 'villager',
    'Elvira': 'villager', 'Sandra': 'villager', 'Krystal': 'villager',
    'Sohrab': 'villager'}
...
game38_roles = {'John': 'werewolf', 'Caroline': 'werewolf', 'Navid': 'werewolf',
    ...
    'Physics': 'seer', 'Platter': 'villager', 'Elvira': 'villager',
    'Sandra': 'villager'}
...
game39_roles = {'Darwin': 'bodyguard', 'Navid': 'werewolf', 'Steve': 'werewolf',
    ...
    'Peter': 'werewolf', 'Physics': 'cursed', 'Caroline': 'villager',
    'Amanda': 'villager', 'Elvira': 'villager', 'Sohrab': 'villager',
    'Platter': 'villager'}
...
game40_roles = {'John': 'bomb', 'Caroline': 'villager', 'Navid': 'bodyguard',
    ...
    'Darwin': 'cursed', 'Amanda': 'seer', 'Sohrab': 'villager',
    'Platter': 'villager'}
...
game41_roles = {'John': 'seer', 'Philippa': 'cursed', 'Amanda': 'villager',
    ...
    'Physics': 'bodyguard', 'Navid': 'villager', 'Caroline': 'villager',
    'Foosball': 'villager', 'Andrew': 'villager'}
...
game42_roles = {'Platter': 'cursed', 'Navid': 'bodyguard', 'Amanda': 'werewolf',
    ...
    'Foosball': 'villager', 'Philippa': 'villager'}
...
game43_roles = {'Darwin': 'werewolf', 'Caroline': 'werewolf',
    ...
    'Steve': 'bodyguard', 'Platter': 'seer', 'John': 'villager',
    'Foosball': 'villager', 'Physics': 'villager', 'Elvira': 'villager',
    'Sandra': 'villager', 'Amanda': 'villager', 'Philippa': 'villager'}
...
game44_roles = {'Darwin': 'bomb', 'Caroline': 'villager', 'Navid': 'werewolf',
    ...
    'Amanda': 'villager', 'Platter': 'seer', 'Physics': 'villager',
    'Peter': 'villager', 'Philippa': 'villager'}
...
game45_roles = {'Caroline': 'werewolf', 'Navid': 'bodyguard',
    ...
    'John': 'villager', 'Physics': 'villager', 'Elvira': 'villager',
    'Sandra': 'villager', 'Amanda': 'villager', 'Philippa': 'villager'}
...
game46_roles = {'John': 'werewolf', 'Andrew': 'cursed', 'Elvira': 'villager',
    ...
    'Caroline': 'villager', 'Navid': 'villager', 'Foosball': 'villager',
    'Physics': 'villager', 'Steve': 'villager', 'Sandra': 'villager',
    'Darwin': 'villager', 'Philippa': 'villager'}
...
game47_roles = {'John': 'bodyguard', 'Caroline': 'villager',
    ...
    'Amanda': 'seer', 'Platter': 'villager', 'Foosball': 'villager',
    'Physics': 'villager', 'Sandra': 'villager', 'Philippa': 'villager'}
...
game48_roles = {'Sartaj': 'villager', 'John': 'villager', 'Sohrab': 'seer',
    ...
    'Caroline': 'villager', 'Darwin': 'villager', 'Peter': 'villager'}
...
game49_roles = {'Sartaj': 'seer', 'Darwin': 'villager', 'Caroline': 'werewolf',
    ...
    'Peter': 'villager', 'Frederick': 'villager', 'Elvira': 'villager'}
...
game50_roles = {'Sartaj': 'villager', 'Muuo': 'werewolf', 'John': 'villager',
    ...
    'Darwin': 'bodyguard', 'Elvira': 'villager', 'Sandra': 'villager',
    'Physics': 'villager', 'Platter': 'villager'}
...
game51_roles = {'Sartaj': 'bodyguard', 'Muuo': 'villager', 'Darwin': 'villager',
    ...
    'Platter': 'werewolf', 'Physics': 'seer', 'Philippa': 'villager',
    'Frederick': 'villager', 'Laura': 'villager'}
...
game52_roles = {'Sartaj': 'villager', 'Muuo': 'villager', 'Darwin': 'villager',
    ...
    'Emily': 'villager', 'Sohrab': 'villager', 'Steve': 'villager',
    'Platter': 'villager'}
...
game53_roles = {'Sartaj': 'villager', 'Muuo': 'bodyguard', 'Darwin': 'villager',
    ...
    'Physics': 'bomb', 'Steve': 'villager', 'Platter': 'villager',
    'Emily': 'villager'}
...
game54_roles = {'Sartaj': 'villager', 'Muuo': 'villager', 'Darwin': 'villager',
    ...
    'Platter': 'villager', 'Sandra': 'villager', 'Physics': 'villager',
    'Emily': 'villager'}
...
game55_roles = {'Muuo': 'villager', 'Platter': 'bodyguard',
    ...
    'Amir': 'werewolf', 'Caroline': 'villager', 'Andrew': 'villager',
    'Sohrab': 'villager', 'Lazar': 'villager'}
...
game56_roles = {'John': 'werewolf', 'Caroline': 'werewolf',
    ...
    'Platter': 'villager', 'Amir': 'villager', 'Muuo': 'villager',
    'Andrew': 'villager', 'Lazar': 'villager'}
...
game57_roles = {'Platter': 'werewolf', 'Darwin': 'villager',
    ...
    'Physics': 'seer', 'Amir': 'villager', 'Muuo': 'villager',
    'John': 'villager', 'Andrew': 'villager'}
...
game58_roles = {'Darwin': 'villager', 'Platter': 'werewolf',
    ...
    'John': 'werewolf', 'Amir': 'bodyguard', 'Muuo': 'villager',
    'Andrew': 'villager', 'Physics': 'villager'}
...
game60_roles = {'Darwin': 'werewolf', 'Caroline': 'bodyguard',
    ...
    'Muuo': 'villager', 'Sohrab': 'villager', 'Frederick': 'villager',
    'Elvira': 'villager', 'Lazar': 'villager'}
...
game61_roles = {'Darwin': 'seer', 'Elvira': 'werewolf', 'Andrew': 'bodyguard',
    ...
    'Muuo': 'villager', 'John': 'villager', 'Sohrab': 'villager',
    'Frederick': 'villager', 'Lazar': 'villager', 'Steve': 'villager',
    'Amir': 'villager'}
...
game63_roles = {'Darwin': 'seer', 'Navid': 'werewolf', 'Foosball': 'werewolf',
    ...
    'Caroline': 'villager', 'Andrew': 'villager', 'Steve': 'villager',
    'Amir': 'villager'}
...
game64_roles = {'Caroline': 'werewolf', 'Foosball': 'bodyguard',
    ...
    'Platter': 'werewolf', 'John': 'villager', 'Navid': 'villager',
    'Sohrab': 'villager', 'Frederick': 'villager', 'Andrew': 'villager',
    'Darwin': 'villager', 'Amir': 'villager'}
...
game65_roles = {'Platter': 'cursed', 'Navid': 'werewolf', 'Sohrab': 'werewolf',
    ...
    'Caroline': 'seer', 'John': 'villager', 'Foosball': 'villager',
    'Lazar': 'villager', 'Peter': 'villager', 'Darwin': 'villager',
    'Amir': 'villager'}
...
game66_roles = {'Darwin': 'bodyguard', 'Navid': 'seer', 'Lazar': 'villager',
    ...
    'Amir': 'werewolf', 'Caroline': 'villager', 'Foosball': 'villager',
    'Sohrab': 'villager', 'Frederick': 'villager', 'Peter': 'villager',
    'Platter': 'villager'}
...
game67_roles = {'Caroline': 'werewolf', 'Navid': 'villager',
    ...
    'Platter': 'seer', 'Amir': 'werewolf', 'John': 'villager',
    'Frederick': 'villager', 'Peter': 'villager'}
...
game68_roles = {'Darwin': 'werewolf', 'Caroline': 'villager',
    ...
    'Platter': 'werewolf', 'Navid': 'villager', 'Frederick': 'villager',
    'Peter': 'villager', 'Amir': 'villager'}
...
game69_roles = {'Alexei': 'villager', 'Sartaj': 'bomb', 'Platter': 'cub',
    ...
    'Darwin': 'werewolf', 'Physics': 'bodyguard', 'Muuo': 'villager'}
...
game70_roles = {'Sartaj': 'villager', 'Muuo': 'bodyguard', 'Platter': 'seer',
    ...
    'John': 'werewolf', 'Physics': 'cub', 'Alexei': 'villager',
    'Elvira': 'villager', 'Sandra': 'villager', 'Darwin': 'villager'}
...
game71_roles = {'Muuo': 'werewolf', 'Platter': 'villager', 'Frederick': 'seer',
    ...
    'Darwin': 'villager', 'Physics': 'bodyguard', 'Sartaj': 'villager',
    'John': 'villager', 'Philippa': 'villager'}
...
dates_list = (game1_date, game2_date, game3_date, game4_date, game5_date,
    ...
    game12_date, game13_date, game14_date, game15_date, game16_date,
    game17_date, game18_date, game19_date, game20_date, game21_date,
    game22_date, game23_date, game24_date, game25_date, game26_date,
    game27_date, game28_date, game29_date, game30_date, game31_date,
    game32_date, game33_date, game34_date, game35_date, game36_date,
    game37_date, game38_date, game39_date, game40_date, game41_date,
    game42_date, game43_date, game44_date, game45_date, game46_date,
    game47_date, game48_date, game49_date, game50_date, game51_date,
    game52_date, game53_date, game54_date, game55_date, game56_date,
    game57_date, game58_date, game59_date, game60_date, game61_date,
    game62_date, game63_date, game64_date, game65_date, game66_date,
    game67_date, game68_date, game69_date, game70_date, game71_date)

numbers_list = (game1_number, game2_number, game3_number, game4_number,
    game5_number, game6_number, game7_number, game8_number, game9_number,
    game10_number, game11_number, game12_number, game13_number, game14_number,
    game15_number, game16_number, game17_number, game18_number, game19_number,
    game20_number, game21_number, game22_number, game23_number, game24_number,
    game25_number, game26_number, game27_number, game28_number, game29_number,
    game30_number, game31_number, game32_number, game33_number, game34_number,
    game35_number, game36_number, game37_number, game38_number, game39_number,
    game40_number, game41_number, game42_number, game43_number, game44_number,
    game45_number, game46_number, game47_number, game48_number, game49_number,
    game50_number, game51_number, game52_number, game53_number, game54_number,
    game55_number, game56_number, game57_number, game58_number, game59_number,
    game60_number, game61_number, game62_number, game63_number, game64_number,
    game65_number, game66_number, game67_number, game68_number, game69_number,
    game70_number, game71_number)

victory_list = (game1_victory, game2_victory, game3_victory, game4_victory,
    game5_victory, game6_victory, game7_victory, game8_victory, game9_victory,
    game10_victory, game11_victory, game12_victory, game13_victory,
    game14_victory, game15_victory, game16_victory, game17_victory,
    game18_victory, game19_victory, game20_victory, game21_victory,
    game22_victory, game23_victory, game24_victory, game25_victory,
    game26_victory, game27_victory, game28_victory, game29_victory,
    game30_victory, game31_victory, game32_victory, game33_victory,
    game34_victory, game35_victory, game36_victory, game37_victory,
    game38_victory, game39_victory, game40_victory, game41_victory,
    game42_victory, game43_victory, game44_victory, game45_victory,
    game46_victory, game47_victory, game48_victory, game49_victory,
    game50_victory, game51_victory, game52_victory, game53_victory,
    game54_victory, game55_victory, game56_victory, game57_victory,
    game58_victory, game59_victory, game60_victory, game61_victory,
    game62_victory, game63_victory, game64_victory, game65_victory,
    game66_victory, game67_victory, game68_victory, game69_victory,
    game70_victory, game71_victory)

roles_list = (game1_roles, game2_roles, game3_roles, game4_roles, game5_roles,
    game6_roles, game7_roles, game8_roles, game9_roles, game10_roles,
    game11_roles, game12_roles, game13_roles, game14_roles, game15_roles,
    game16_roles, game17_roles, game18_roles, game19_roles, game20_roles,
    game21_roles, game22_roles, game23_roles, game24_roles, game25_roles,
    game26_roles, game27_roles, game28_roles, game29_roles, game30_roles,
    game31_roles, game32_roles, game33_roles, game34_roles, game35_roles,
    game36_roles, game37_roles, game38_roles, game39_roles, game40_roles,
    game41_roles, game42_roles, game43_roles, game44_roles, game45_roles,
    game46_roles, game47_roles, game48_roles, game49_roles, game50_roles,
    game51_roles, game52_roles, game53_roles, game54_roles, game55_roles,
    game56_roles, game57_roles, game58_roles, game59_roles, game60_roles,
    game61_roles, game62_roles, game63_roles, game64_roles, game65_roles,
    game66_roles, game67_roles, game68_roles, game69_roles, game70_roles,
    game71_roles)

raw_seq_list = (game1_raw_seq_dead, game2_raw_seq_dead, game3_raw_seq_dead,
    game4_raw_seq_dead, game5_raw_seq_dead, game6_raw_seq_dead,
    game7_raw_seq_dead, game8_raw_seq_dead, game9_raw_seq_dead,
    game10_raw_seq_dead, game11_raw_seq_dead, game12_raw_seq_dead,
    game13_raw_seq_dead, game14_raw_seq_dead, game15_raw_seq_dead,
    game16_raw_seq_dead, game17_raw_seq_dead, game18_raw_seq_dead,
    game19_raw_seq_dead, game20_raw_seq_dead, game21_raw_seq_dead,
    game22_raw_seq_dead, game23_raw_seq_dead, game24_raw_seq_dead,
    game25_raw_seq_dead, game26_raw_seq_dead, game27_raw_seq_dead,
    game28_raw_seq_dead, game29_raw_seq_dead, game30_raw_seq_dead,
    game31_raw_seq_dead, game32_raw_seq_dead, game33_raw_seq_dead,
    game34_raw_seq_dead, game35_raw_seq_dead, game36_raw_seq_dead,
    game37_raw_seq_dead, game38_raw_seq_dead, game39_raw_seq_dead,
    game40_raw_seq_dead, game41_raw_seq_dead, game42_raw_seq_dead,
    game43_raw_seq_dead, game44_raw_seq_dead, game45_raw_seq_dead,
    game46_raw_seq_dead, game47_raw_seq_dead, game48_raw_seq_dead,
    game49_raw_seq_dead, game50_raw_seq_dead, game51_raw_seq_dead,
    game52_raw_seq_dead, game53_raw_seq_dead, game54_raw_seq_dead,
    game55_raw_seq_dead, game56_raw_seq_dead, game57_raw_seq_dead,
    game58_raw_seq_dead, game59_raw_seq_dead, game60_raw_seq_dead,
    game61_raw_seq_dead, game62_raw_seq_dead, game63_raw_seq_dead,
    game64_raw_seq_dead, game65_raw_seq_dead, game66_raw_seq_dead,
    game67_raw_seq_dead, game68_raw_seq_dead, game69_raw_seq_dead,
    game70_raw_seq_dead, game71_raw_seq_dead)

cult_l_list = (game1_cult_leader, game2_cult_leader, game3_cult_leader,
    game4_cult_leader, game5_cult_leader, game6_cult_leader, game7_cult_leader,
    game8_cult_leader, game9_cult_leader, game10_cult_leader,
    game11_cult_leader, game12_cult_leader, game13_cult_leader,
    game14_cult_leader, game15_cult_leader, game16_cult_leader,
    game17_cult_leader, game18_cult_leader, game19_cult_leader,
    game20_cult_leader, game21_cult_leader, game22_cult_leader,
    game23_cult_leader, game24_cult_leader, game25_cult_leader,
    game26_cult_leader, game27_cult_leader, game28_cult_leader,
    game29_cult_leader, game30_cult_leader, game31_cult_leader,
    game32_cult_leader, game33_cult_leader, game34_cult_leader,
    game35_cult_leader, game36_cult_leader, game37_cult_leader,
    game38_cult_leader, game39_cult_leader, game40_cult_leader,
    game41_cult_leader, game42_cult_leader, game43_cult_leader,
    game44_cult_leader, game45_cult_leader, game46_cult_leader,
    game47_cult_leader, game48_cult_leader, game49_cult_leader,
    game50_cult_leader, game51_cult_leader, game52_cult_leader,
    game53_cult_leader, game54_cult_leader, game55_cult_leader,
    game56_cult_leader, game57_cult_leader, game58_cult_leader,
    game59_cult_leader, game60_cult_leader, game61_cult_leader,
    game62_cult_leader, game63_cult_leader, game64_cult_leader,
    game65_cult_leader, game66_cult_leader, game67_cult_leader,
    game68_cult_leader, game69_cult_leader, game70_cult_leader,
    game71_cult_leader)

items_list = (game1_items, game2_items, game3_items, game4_items, game5_items,
    game6_items, game7_items, game8_items, game9_items, game10_items,
    game11_items, game12_items, game13_items, game14_items, game15_items,
    game16_items, game17_items, game18_items, game19_items, game20_items,
    game21_items, game22_items, game23_items, game24_items, game25_items,
    game26_items, game27_items, game28_items, game29_items, game30_items,
    game31_items, game32_items, game33_items, game34_items, game35_items,
    game36_items, game37_items, game38_items, game39_items, game40_items,
    game41_items, game42_items, game43_items, game44_items, game45_items,
    game46_items, game47_items, game48_items, game49_items, game50_items,
    game51_items, game69_items, game70_items, game71_items, game52_items,
    game53_items, game54_items, game55_items, game56_items, game57_items,
